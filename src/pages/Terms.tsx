        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          ...
          <Card className="p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div>
                <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold mb-3 sm:mb-4">Welcome to VibeNiche</h2>
              ...
              <div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <span className="text-sm sm:text-base text-muted-foreground">VibeNiche may earn commissions from qualifying purchases</span>
                  </div>
                </div>
              </div>
            </div>
