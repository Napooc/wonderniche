...
const Travel = () => {
  ...
  return <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <CategoryHero title="Travel Essentials" subtitle="Premium travel gear and accessories for the modern explorer and digital nomad" images={[travelHero1]} ctaText="Explore Travel Gear" onCtaClick={() => document.getElementById('products')?.scrollIntoView({
      behavior: 'smooth'
    })} />
          ...
          <div className="mb-12 space-y-6 reveal-up">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input type="text" placeholder="Search travel products..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-10 pr-4 py-3 bg-input rounded-full text-foreground placeholder:text-muted-foreground border border-border focus:outline-none focus:ring-2 focus:ring-primary" />
              </div>
