          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {adviceCategories.map((category, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`glass-card p-6 text-center hover:scale-105 transition-all duration-300 reveal-up stagger-${index + 1}`}
                >
                  <div className="mb-4">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid md:grid-cols-3 gap-8 text-center reveal-up">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">Expert Resources</p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <div className="text-4xl font-bold gradient-text">98.5%</div>
          ...
          <div className="mb-12 space-y-6 reveal-up">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="Search advice and resources..."
                  value={searchTerm}
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  <ProductCard 
                    ...
                    image={product.image_url || 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=600&fit=crop'}
                    category="Advice"
