export default {
  ...
  "footer": {
    ...
    "privacy": "개인정보처리방침",
    "terms": "서비스 약관",
    "copyright": "© 2024 WonderNiche. 모든 권리 보유."
  },
  "about": {
    "title": "WonderNiche 소개",
    ...
    "vibeNicheBorn": "그래서 WonderNiche가 탄생했습니다 — 뷰티 애호가, 웰니스 추구자, 여행 애호가들이 투명하고 정직한 제휴 추천을 통해 엄선된 고품질 제품을 발견할 수 있는 신뢰할 수 있는 목적지입니다.",
  ...
  "contact": {
    ...
    "aboutWonderNiche": "WonderNiche 소개",
    "foundedDescription": "2016년에 설립된 WonderNiche는 라이프스타일 우수성의 당신의 신뢰할 수 있는 큐레이터입니다. 우리는 뷰티, 여행, 웰니스, 라이프스타일 카테고리에서 최고의 제품을 발견하고 공유하는 데 특화되어 있습니다.",
    ...
    "faq1": {
      "question": "제휴 마케팅이 무엇이며 WonderNiche는 어떻게 작동하나요?",
      "answer": "WonderNiche는 최고의 라이프스타일 제품으로 당신을 연결하는 프리미엄 제휴 마케팅 플랫폼입니다. 우리는 큐레이션된 추천을 통해 구매할 때 수수료를 받아 정직한 리뷰를 제공하고 당신에게 비용 없이 플랫폼을 유지할 수 있게 합니다."
    },
    "faq2": {
